...
import { MatzipForm } from '../types/interfaces';
...
`;
export default function Matjyp() {
    ...
    return (
        <>
            ...
            <h1>맛집</h1>
            <Inner>
                <MatzipHeader dobong={showDobong} mapo={showMapo} gangdong={showGangdong} setDobong={setShowDobong} setMapo={setShowMapo} setGangdong={setShowGangdong} />
                <GridDiv>
